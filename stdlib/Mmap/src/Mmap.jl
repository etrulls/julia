...
function settings(s::RawFD, shared::Bool)
    ...
    if s == INVALID_HANDLE_VALUE
        ...
        mode = ccall(:fcntl, Cint, (RawFD, Cint), s, F_GETFL)
...
function mmap(io::IO,
    ...
    @static if Sys.isunix()
        ...
        # mmap the file
        ptr = ccall(:jl_mmap, Ptr{Void}, (Ptr{Void}, Csize_t, Cint, Cint, RawFD, Int64),
        ...
        handle = create ? ccall(:CreateFileMappingW, stdcall, Ptr{Void}, (OS_HANDLE, Ptr{Void}, DWORD, DWORD, DWORD, Cwstring),
